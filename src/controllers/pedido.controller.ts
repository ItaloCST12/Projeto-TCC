...
export const criarPedido = async (req: Request, res: Response) => {
  try {
    ...
    const { produtoId, quantidade, unidade, tipoEntrega, items } = req.body;
    const pedido = await pedidoService.criarPedido(usuarioId, produtoId, quantidade, unidade, tipoEntrega, items);
