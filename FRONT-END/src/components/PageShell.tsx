  ...
  return (
    <div className={cn("container mx-auto max-w-6xl px-4 pt-24 pb-28 sm:pb-32 lg:pb-10", containerClassName)}>
      <div className="mb-7 flex flex-wrap items-start justify-between gap-3 rounded-2xl border border-border/75 bg-card/90 px-5 py-5 sm:px-6">
        <div>
          <h1 className="mb-1 inline-flex items-center gap-2 font-display text-3xl sm:text-4xl font-bold tracking-tight text-foreground">
            {titleIcon && <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-border/70 bg-muted/60 text-primary">{titleIcon}</span>}
            <span>{title}</span>
          </h1>
